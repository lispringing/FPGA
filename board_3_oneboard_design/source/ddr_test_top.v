...
wire    [31:0]                      gray_rgb32;      // 灰度转32bit RGB（给fifo1）
/******************************reg********************************************/
...
.video1_de_in            (gray_de),         // 【修改】对接灰度化的de_out
.video1_data_in          (gray_rgb32),      // 【修改】对接灰度化的32bit RGB
...
gray_convert u_gray_convert(
    ...
    .de_in         (zoom_de_out),                   // 输入de：对接video_zoom的de_out
    .r_in          (zoom_data_out[31:24]),         // 输入R：video_zoom的高8位
    .g_in          (zoom_data_out[21:14]),         // 输入G：video_zoom的中8位
    .b_in          (zoom_data_out[11:4]),          // 输入B：video_zoom的低8位
    .de_out        (gray_de),                       // 输出de：给fifo1
    .gray_out      (gray_data)                      // 输出灰度：给fifo1
);
